...
<form action="sqlmateria.php" onsubmit="return confirmSubmit(REF.value)" method="post" name="alta" enctype="multipart/form-data" > 
...
<tr><td align=center>
<BUTTON name=submit value=baja type=submit>Baja</BUTTON>
</FORM>
</td><td></td></tr>
