...
<form action="m2materia.php" onsubmit="return confirmSubmit(REF.value)" method="post" name="alta" enctype="multipart/form-data" > 
...
<tr><td align=center>
<BUTTON name=submit value=modifica type=submit>Modifica</BUTTON>
</FORM>
</td><td></td></tr>
