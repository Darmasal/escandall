...
style='font-family:Arial'>LOG D'ENTRADA I SORTIDA<o:p></o:p></span></p>
...
$local_query = 'SELECT * from v_control ORDER BY DATA ASC'; 

$resultat = mysql_query($local_query);

echo "<center><table border=1>";
echo "<tr><td>TIPUS</td><td>COLOR</td><td>DIA</td><td>E o S</td><td>Quantitat</td></tr>";

while ($row = mysql_fetch_array($resultat)) {

echo "<tr><td>";
echo "<p class=MsoNormal align=center style='text-align:center'><span";
echo "style='font-family:Arial'>",$row["TIPUs"],"<o:p></o:p></span></p>";
echo "</td>";

echo "<td>";
echo "<p class=MsoNormal align=center style='text-align:center'><span";
echo "style='font-family:Arial'>",$row["COLOR"],"<o:p></o:p></span></p>";
echo "</td>";

echo "<td>";
echo "<p class=MsoNormal align=center style='text-align:center'><span";
echo "style='font-family:Arial'>",$row["DIA"],"<o:p></o:p></span></p>";
echo "</td>";

echo "<td>";
echo "<p class=MsoNormal align=center style='text-align:center'><span";
echo "style='font-family:Arial'>",$row["ES"],"<o:p></o:p></span></p>";
echo "</td>";

echo "<td>";
echo "<p class=MsoNormal align=center style='text-align:center'><span";
echo "style='font-family:Arial'>",$row["QTY"],"<o:p></o:p></span></p>";
echo "</td></tr>";
